...
async function loginUser(userData: { email: any; password: any; }) {
    const response = await fetch(`${BASE_URL}`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
...
async function sendMessage(userData: { access_token: any; client: any; uid: any; expiry: any; receiver_id: any; receiver_class: any; body: any; }) {
...
async function getMessages(userData: { access_token: any; client: any; uid: any; expiry: any; }) {
    const response = await fetch(`${BASE_URL}messages`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
...
async function createChannel(userData: { access_token: any; client: any; uid: any; expiry: any; name: any; user_ids: any; }) {
...
async function getChannels(userData: { access_token: any; client: any; uid: any; expiry: any; }) {
    const response = await fetch(`${BASE_URL}channels`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
...
async function getChannelDetails(userData: { channel_id: any; access_token: any; client: any; uid: any; expiry: any; }) {
...
async function addMember(userData: { channel_id: any; access_token: any; client: any; uid: any; expiry: any; id: any; member_id: any; }) {
